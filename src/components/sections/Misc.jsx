    ...
    return (
        <section className='content-pane form-content'>
            ...
            <section className='label-field-box misc-fields'>
                ...
                <textarea className="other-skills" id="other-skills" value={formData.otherSkills} onChange={(e) => setFormData((prev) => ({...prev, misc: {...prev.misc, otherSkills: e.target.value}}))}></textarea>
            </section>
